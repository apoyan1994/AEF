...
public class CategoryChooserSliderView extends View {
	...
	public CategoryChooserSliderView(Context context) {
		super(context);
		this.context = context;
		init();
	}

	public CategoryChooserSliderView(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.context = context;
		init();
	}

	public CategoryChooserSliderView(Context context, AttributeSet attrs, int defStyleAttr) {
