...
public class ConBigText {
	...
	public static final String NEWS_FIRST_GRADUATING_ARTSAKH_TEXT = "In May 2013 the Armenian Educational Foundation announced $100,000 funding towards establishing a four-year Computer Information Systems (CIS) degree program, in Artsakh State University (the University), in Stepanakert and signed an agreement with the University in the same year. The funding was to help finance computer hardware, software, instructor salaries, and student scholarships and start a four-year Computer Information Systems degree program with the aim of promoting IT, modern technology and employment and empowerment in Artsakh.\n" +
			"\n" +
	...
	public static final String AEF_SARF_PRESS_RELEASE_TEXT = "Contact Information:\n" +
